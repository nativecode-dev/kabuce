...
import { Controller, Get, PathParams, Post, BodyParams, Put, Returns, ReturnsArray } from '@tsed/common'
...
export class OrganizationLocations {
  ...
  @Returns(404, { description: 'Not found' })
  get(@PathParams('organization_location_id') organization_location_id: string) {
    throw new NotFound(`Organization with id ${organization_location_id} not found`)
  }
