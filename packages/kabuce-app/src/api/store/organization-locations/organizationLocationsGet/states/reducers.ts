...
export const getOrganizationLocationsGetStateSelector = createFeatureSelector<OrganizationLocationsGetState>(
  selectorName,
)

export function OrganizationLocationsGetReducer(
  state: OrganizationLocationsGetState = initialOrganizationLocationsGetState,
  action: actions.OrganizationLocationsGetAction,
): OrganizationLocationsGetState {
  switch (action.type) {
