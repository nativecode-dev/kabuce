...
export const getOrganizationLocationsPutStateSelector = createFeatureSelector<OrganizationLocationsPutState>(
  selectorName,
)

export function OrganizationLocationsPutReducer(
  state: OrganizationLocationsPutState = initialOrganizationLocationsPutState,
  action: actions.OrganizationLocationsPutAction,
): OrganizationLocationsPutState {
  switch (action.type) {
