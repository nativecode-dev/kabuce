...
export const getOrganizationLocationsPostStateSelector = createFeatureSelector<OrganizationLocationsPostState>(selectorName);
...
export function OrganizationLocationsPostReducer(
  ...
  action: actions.OrganizationLocationsPostAction): OrganizationLocationsPostState {
  switch (action.type) {
