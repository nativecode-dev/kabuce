...
export const getOrganizationTemplatesPostStateSelector = createFeatureSelector<OrganizationTemplatesPostState>(
  selectorName,
)
...
export function OrganizationTemplatesPostReducer(
  ...
  action: actions.OrganizationTemplatesPostAction,
): OrganizationTemplatesPostState {
  switch (action.type) {
