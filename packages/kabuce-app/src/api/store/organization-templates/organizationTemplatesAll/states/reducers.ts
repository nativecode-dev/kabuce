...
export const getOrganizationTemplatesAllStateSelector = createFeatureSelector<OrganizationTemplatesAllState>(selectorName);

export function OrganizationTemplatesAllReducer(
  state: OrganizationTemplatesAllState = initialOrganizationTemplatesAllState,
  action: actions.OrganizationTemplatesAllAction): OrganizationTemplatesAllState {
  switch (action.type) {
