...
@Injectable()
export class OrganizationAccountsPutFormService {
  form: FormGroup
  constructor(private organizationAccountsService: OrganizationAccountsService) {
    this.form = new FormGroup({
      ...
      account_id: new FormControl(undefined, [Validators.required]),
      body: new FormGroup(
        {
          account_reference: new FormControl(undefined, [
          ...
          owner_name: new FormControl(undefined, [
            Validators.maxLength(128),
            Validators.minLength(8),
            Validators.required,
          ]),
  ...
  submit(raw = false) {
    ...
    return this.organizationAccountsService.organizationAccountsPut(data)
  }
}
