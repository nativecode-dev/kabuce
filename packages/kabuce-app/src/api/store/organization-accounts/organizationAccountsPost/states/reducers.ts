...
export const getOrganizationAccountsPostStateSelector = createFeatureSelector<OrganizationAccountsPostState>(
  selectorName,
)

export function OrganizationAccountsPostReducer(
  state: OrganizationAccountsPostState = initialOrganizationAccountsPostState,
  action: actions.OrganizationAccountsPostAction,
): OrganizationAccountsPostState {
  switch (action.type) {
